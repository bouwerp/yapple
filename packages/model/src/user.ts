...
export class MongoDBUserReadRepository extends MongoDBRepository implements ReadRepository<User, Filter<User>> {
    async find(input: FindInput<Filter<User>>): Promise<FindOutput<User>> {
